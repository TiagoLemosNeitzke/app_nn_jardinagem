                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <x-form route="task.done" key="task" id="{{ $task->id }}" method="POST"
                                    http-verb="PUT">
                                    <input type="number" name="id" value="{{ $task->id }}" class="hidden">
                                    @if ($task->did_day === null)
                                        <x-button text="Realizado" type="submit">
                                ...
                                @if ($task->did_day === null)
                                    <x-link route="task.edit" key="task" id="{{ $task->id }}" text="Editar">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                ...
                                <x-form route="task.destroy" key="task" id="{{ $task->id }}" method="POST"
                                    http-verb="DELETE">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title fw-bold text-light" id="exampleModalLabel">Siga as instruções para agendar um
                        serviço</h5>
                ...
                <div class="modal-body">
                    <ul>
                        ...
                        <li>Clique no botão <span class="fw-bold">agendar</span> no card do cliente que você deseja criar o
                            agendamento</li>
                        <li>Preencha no campo <span class="fw-bold">Agendar para dia</span> escolhendo a data no calendário
                            no canto direito</li>
                        <li>Preencha no campo <span class="fw-bold">Valor do serviço</span> coloque somente números, sem
                            virgulas ou pontos</li>
                        <li>Clique em <span class="fw-bold">Agendar</span></li>
                        <li>Caso algum campo esteja preenchido incorretamente você deverá receber uma mensagem de erro,
                            corrija o erro e envie novamente o formulário clicando em <span class="fw-bold">Agendar</span>
                        </li>
                    </ul>
                </div>
            </div>
