            ...
            <div class="col-4">
                <div class="card border-success border">
                    <div class="card-body">
                        ...
                        <div class="">
                            <form action="{{ route('toReceive.update', ['toReceive' => $toReceive->id]) }}" method="post">
                                @method('put')
                                @csrf
                                <button type="submit" class="btn btn-success w-100" title="Marcar tarefa como realizada."><svg
