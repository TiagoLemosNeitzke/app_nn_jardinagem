                            ...
                            <div class="col-md-6 mb-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <x-link route="customer.show" key="customer" id="{{ $customer->id }}"
                                            text="Ver mais" title="Ver mais dados do cliente">
                                        ...
                                        <x-link route="customer.edit" key="customer" id="{{ $customer->id }}"
                                            text="Editar">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                        ...
                                        <x-form route="customer.destroy" key="customer" id="{{ $customer->id }}"
                                        ...
                                        <x-link route="task.create" key="customer" id="{{ $customer->id}}" text="Agendar" title="Realizar agendamento.">
